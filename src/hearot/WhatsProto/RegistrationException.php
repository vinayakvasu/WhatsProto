 ...
 *  @license GNU AGPL v3
 *
 *  @method boolean __construct(string $message, int $code, string $previous) This method will throw an hearot\WhatsProto\RegistrationException
...
class RegistrationException extends \Exception
{
    ...
    {
        /**
         *  This method will throw an hearot\WhatsProto\RegistrationException
         *
         * @internal
