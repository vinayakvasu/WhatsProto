 ...
 *  @license GNU AGPL v3
 *
 *  @method boolean Log(string $string, string $foreground_color, string $background_color, string $style) This method will print the log in a console using the style and colors passed by parameters
 */
    class Logger
    {
        /**
      ...
      'hidden' => '8'
        ...
        public static function Log($string, $foreground_color = null, $background_color = null, $style = null)
        {
            /**
